...
const useAnimationLoop = (
  ...
  }, [trackRef, targetVelocity, seqWidth, seqHeight, isHovered, hoverSpeed, isVertical, paused]);
};
...
export const LogoLoop = React.memo<LogoLoopProps>(
  ({
    ...
    const dimensionRefs = useMemo(() => [containerRef, seqRef], []);
    useResizeObserver(updateDimensions, dimensionRefs);
