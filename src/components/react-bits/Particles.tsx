...
const Particles: React.FC<ParticlesProps> = ({
  ...
  useEffect(() => {
    ...
    try {
      ...
      // The CSS blueprint remains visible when WebGL is unavailable.
      return;
    }
    ...
    const syncAnimation = () => {
      if (visible && !document.hidden && !contextLost && !animationFrameId) {
        lastTime = performance.now();
        animationFrameId = requestAnimationFrame(update);
      } else if (!visible || document.hidden || contextLost) {
